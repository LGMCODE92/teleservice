...
public class OperatorRegister extends JFrame {
	...
	public OperatorRegister() {
		...
		nameOperator.setBounds(85, 62, 100, 14);
		contentPane.add(nameOperator);
		
		JLabel surnameOperator = new JLabel("Apellidos:");
		surnameOperator.setBounds(85, 87, 100, 14);
		...
		txtNameOperator.setBounds(199, 59, 96, 20);
		...
		txtEmailOperator.setBounds(199, 134, 96, 20);
		...
		txtPw.setColumns(10);
		txtPw.setBounds(195, 186, 100, 20);
